...
import ClientForm from "@/app/(operador)/configuraciones/components/clientes/ClientForm";
...
import { useCategory } from "@/app/(operador)/configuraciones/hooks/proveedores/useCategory";
...
export default function NewRequest() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Notifica a la tabla para refrescar solicitudes sin recargar la página.
      window.dispatchEvent(new CustomEvent("chofer:request-created"));
  ...
  useEffect(() => {
    setCliente(""); // Resetear cliente al cambiar de ruta o limpiar ruta
